...
#Region "Listar"
        ...
        Public Function ListarObservacionPadinActivos(objEntCol As Entity.Estadistica.PadinDetalleCol) As Entity.Estadistica.PadinDetalleCol
            ...
            Dim tieneObservacionEnPenal As Boolean = False

            For Each obj As Entity.Estadistica.PadinDetalle In objEntCol

                strMensaje = ""
                tieneObservacionEnPenal = False
                With obj
                    ...
                    obj.TieneObservacionEnPenal = tieneObservacionEnPenal
                End With
                ...
                For Each f As System.Data.DataRow In filas
                    Select Case f("doc_tip_id").ToString
                        ...
                        Case Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Queda
                            ...
                            Dim NroExp As String = f("int_sen_exp_num").ToString
                            Dim fil As DataRow()
                            With objEnt
                                If f("int_exp_visible").ToString = 1 And f("int_del_sen_dmp").ToString = True Then
                                    ...
                                    .SentenciaPenaImpuestaDia = f("int_sen_dia").ToString
                                End If
                                If f("int_exp_visible").ToString = 0 Then
                                    fil = t.Select("int_exp_pad_id=" & f("int_exp_id").ToString & " and int_sen_doc_fec_rcp<=" & FechaFin)
                                    If fil.Count > 0 Then
                                        .SentenciaDelitoID = fil(0)("int_del_gen_id").ToString
                                        .SentenciaDelitoGenerico = fil(0)("int_del_gen_nom").ToString
                                        .SentenciaDelitoEspecificoID = fil(0)("int_del_esp_id").ToString
                                        .SentenciaDelitoEspecifico = fil(0)("int_del_esp_nom").ToString
                                        .SentenciaPenaImpuestaAnio = fil(0)("int_sen_anio").ToString
                                        .SentenciaPenaImpuestaMes = fil(0)("int_sen_mes").ToString
                                        .SentenciaPenaImpuestaDia = fil(0)("int_sen_dia").ToString
                                        If intDias >= 30 Then
                                            intMeses = (intDias \ intMaxNumDias) + intMeses
                                            intDias = intDias - ((intDias \ intMaxNumDias) * intMaxNumDias)
                                        End If
                                        ...
                                        .SentenciaPenaImpuestaMes = intMeses
                                        .SentenciaPenaImpuestaDia = intDias
                                        .SentenciaFechaIni = fil(0)("int_sen_fec_ini").ToString
                                        .SentenciaFechaFin = fil(0)("int_sen_fec_fin").ToString
                                    End If
                                End If
                                'Primera instancia
                                fil = t.Select("int_sen_exp_num=" & "'" & NroExp & "'" & " and doc_tip_id in (17,27) and int_sen_doc_fec_rcp<=" & FechaFin)
                                If fil.Count > 0 Then
                                    .SentenciaID = fil(0)("int_sen_id").ToString
                                    .SentenciaExpedienteID = fil(0)("int_exp_id").ToString
                                    .SentenciaPIFecha = fil(0)("int_sen_fec").ToString
                                    .SentenciaPIDistritoJudicial = fil(0)("aut_jud_nom").ToString.ToUpper
                                    .SentenciaPISalaJuzgado = fil(0)("sal_jud_nom").ToString.ToUpper
                                    .SentenciaPIExpedienteNumero = fil(0)("int_sen_exp_num").ToString
                                End If
                                'Segunda instancia
                                fil = t.Select("int_sen_exp_num=" & "'" & NroExp & "'" & " and doc_tip_id in (21,22) and int_sen_doc_fec_rcp<=" & FechaFin)
                                If fil.Count > 0 Then
...
#Region "Listar_Datos_Complementarios"
        ...
        Public Sub DatosComplementarios_plm_v6(PadinID As Integer, RegionID As Integer, PenalID As Integer, FechaIni As Long, FechaFin As Long,
            ...
            For Each objEntInterno As Entity.Estadistica.PadinDetalle In objEntColInterno
                ...
                ' If objEntInterno.InternoID = 1185 Then MsgBox(objEntInterno.InternoID)
                With objEntInterno
                    .Codigo = -1
