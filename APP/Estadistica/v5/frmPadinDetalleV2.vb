...
#Region "Propiedades_Busqueda"
        ...
        Private Property VerObservados As Boolean
            ...
            End Set
        End Property
        Private Property VerObservadosEnPenal As Boolean
            Get
                Return Me.chkRegistrosObservadosEnPenal.Checked
            End Get
            Set(value As Boolean)
                Me.chkRegistrosObservadosEnPenal.Checked = value
            End Set
        End Property
#End Region
...
#Region "Listar"
        ...
        Private Function ListarFiltro(objEntCol As Entity.Estadistica.PadinDetalleCol) As Entity.Estadistica.PadinDetalleCol
            ...
            If Me.CodigoInterno.Length < 1 And Me.ApellidosyNombresyAsociados.Length < 1 And Me.SituacionJuridica = -1 And VerObservados = False And VerObservadosEnPenal = False Then
                Return objEntCol
            End If
            For Each obj As Entity.Estadistica.PadinDetalle In objEntCol
                ...
                If (Me.CodigoInterno = obj.InternoCodigo) Or Me.CodigoInterno.Length < 1 Then
                    ...
                    (Me.SituacionJuridica = obj.IngresoSituacionJuridicaID Or Me.SituacionJuridica = -1) Then
                        ...
                        If Me.VerObservados = True And Me.VerObservadosEnPenal = False Then
                            If obj.ObservacionRegistro.Length > 1 Then
                                Value.Add(obj)
                            End If
                        ElseIf Me.VerObservadosEnPenal = True Then
                            If obj.TieneObservacionEnPenal = True Then
                                Value.Add(obj)
                            End If
                        Else
                            Value.Add(obj)
...
#End Region
        ...
        Private Sub TabControl1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TabControl1.SelectedIndexChanged
            ...
            Me.chkRegistrosObservadosEnPenal.Checked = False
            ...
            Me.chkRegistrosObservadosEnPenal.Visible = blnVerObs
        ...
        Private Sub ckbRegistrosObservados_CheckedChanged(sender As Object, e As System.EventArgs) Handles chkRegistrosObservados.CheckedChanged
            tsp_btnBuscar_Click(Nothing, Nothing)
        End Sub
        Private Sub ckbRegistrosObservadosEnPenal_CheckedChanged(sender As Object, e As System.EventArgs) Handles chkRegistrosObservadosEnPenal.CheckedChanged
            tsp_btnBuscar_Click(Nothing, Nothing)
        End Sub
